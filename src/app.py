...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, drills, and play matches against other schools",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ari@mergington.edu", "bella@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Science Club": {
        "description": "Conduct experiments and investigate scientific challenges",
